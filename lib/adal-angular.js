    ...
    if (angular) {
        ...
        AdalModule.provider('adalAuthenticationService', function () {
            ...
            this.$get = ['$rootScope', '$window', '$q', '$location', '$timeout', '$injector', function ($rootScope, $window, $q, $location, $timeout, $injector) {
                ...
                /**
                 * Logs the user in calling adal and returning a promise of resolution
                 * If not aleady in progress creates a new promise.
                 * If already in progress returns the existing promise.
                 * @returns {*}
                 */
                var adalLogin = function() {
                    if(!loginDeferred) {
                        loginDeferred = $q.defer();

                        _adal.login(function (error) {
                            if (error) {
